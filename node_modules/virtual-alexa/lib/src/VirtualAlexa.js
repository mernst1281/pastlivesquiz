...
class VirtualAlexaBuilder {
    ...
    create() {
        ...
        let interactor;
        if (this._handler) {
            interactor = new LocalSkillInteractor_1.LocalSkillInteractor(this._handler, model, this._applicationID);
        }
        else if (this._skillURL) {
            interactor = new RemoteSkillInteractor_1.RemoteSkillInteractor(this._skillURL, model, this._applicationID);
        }
        else {
