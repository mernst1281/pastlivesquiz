...
class SkillInteractor {
    constructor(model, applicationID) {
        this.model = model;
        this.skillContext = null;
        const audioPlayer = new AudioPlayer_1.AudioPlayer(this);
        this.skillContext = new SkillContext_1.SkillContext(this.model, audioPlayer, applicationID);
        this.skillContext.newSession();
    }
    context() {
        return this.skillContext;
    }
    spoken(utteranceString, requestFilter) {
    ...
    sessionEnded(sessionEndedReason, errorData, requestFilter) {
    ...
    intended(intentName, slots, requestFilter) {
        try {
    ...
    callSkill(serviceRequest, requestFilter) {
    ...
    callSkillWithIntent(intentName, slots, requestFilter) {
